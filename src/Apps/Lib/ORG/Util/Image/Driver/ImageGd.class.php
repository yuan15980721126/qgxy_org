...
class ImageGd{
     ...
     */
    public function __construct($imgname = null, $bgColor = array(255, 255, 255)) {
    ...
    public function crop($w, $h, $x = 0, $y = 0, $width = null, $height = null){
        ...
        do {
            ...
            // 调整默认颜色
            $color = imagecolorallocate($img, $this->bgColor[0], $this->bgColor[1], $this->bgColor[2]);
    ...
    public function thumb($width, $height, $type = THINKIMAGE_THUMB_SCALING){
        ...
        switch ($type) {
            ...
            case THINKIMAGE_THUMB_FILLED_FOREVER:
                //计算缩放比例
                if($w < $width && $h < $height){
                    $scale = 1;
                } else {
                ...
                if($type == THINKIMAGE_THUMB_FILLED_FOREVER) {
                    $scale = min($width/$w, $height/$h);
                }
    ...
    public function water($source, $locate = THINKIMAGE_WATER_SOUTHEAST){
        ...
        do{
            ...
            // 调整默认颜色
            $color = imagecolorallocate($src, $this->bgColor[0], $this->bgColor[1], $this->bgColor[2]);
