...
class Page extends Think {
	...
	public function  show(){
		...
		$output .= '<li><a class="page-prev" href="'.$this->pageurl($urlrule, $pre_page,$this->parameter).'">&lt</a></li>';
		...
		$output .='<li><a class="page-next" href="'.$this->pageurl($urlrule,$next_page,$this->parameter).'">&gt;</a></li>'; 
