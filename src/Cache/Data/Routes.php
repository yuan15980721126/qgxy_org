...
'/^(en|cn)\/([\w^_]+)\/show\/(\d+)_(\d+)$/' => 'Urlrule/show?l=:1&catdir=:2&id=:3&p=:4&',
'/^([\w^_]+)\/show\/(\d+)_(\d+)$/' => 'Urlrule/show?catdir=:1&id=:2&p=:3&',
'/^(en|cn)\/([\w^_]+)\/show\/(\d+)$/' => 'Urlrule/show?l=:1&catdir=:2&id=:3&',
'/^([\w^_]+)\/show\/(\d+)$/' => 'Urlrule/show?catdir=:1&id=:2&',
'/^(en|cn)\/([\w^_]+)\/(\d+)$/' => 'Urlrule/index?l=:1&catdir=:2&p=:3&',
'/^([\w^_]+)\/(\d+)$/' => 'Urlrule/index?catdir=:1&p=:2&',
'/^(en|cn)\/([\w^_]+)$/' => 'Urlrule/index?l=:1&catdir=:2&',
